...
public class ClanIzmena extends JDialog{
	...
	private Clan clan;
	 ...
	 public ClanIzmena(Biblioteka biblioteka,Clan clan) {
	 ...
	 private void initActions() {	
			btnCancel.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					ClanIzmena.this.dispose();
					ClanIzmena.this.setVisible(false);
				}
			});
	 ...
	 private void initGUI() {
			...
			if(clan != null) {
				...
				cmbxPol.setSelectedItem(clan.getPol());
				txtbrClankarte.setText(clan.getBrClanskeKarte());
				txtdatumPoslednjeUplate.setText((clan.getDatumUplate()).toString());
				txtbrojmeseci.setText(Integer.toString(clan.getUplacenoMeseci()));
				chbAktivnost.setSelected(clan.isAktivan());
